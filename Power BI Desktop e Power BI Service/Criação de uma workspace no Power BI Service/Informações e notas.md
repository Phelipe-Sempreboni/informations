#### Criação de uma Workspace e carregamento de um relatório para o Power BI Service - Nuvem.

---

 - [x] Sobre o tutorial:
 
 Criar uma Workspace (espaço de trabalho) no Power BI, permitei o carregamento de datasets (conjunto de dados), relatórios e dashboards, além de permitir criar aplicativos dentro da Workspace para compartilhamento de informações entre outras pessoas.
...
* Não é possível criar Workspaces com uma conta gratuita. Necessário estar na licença do Power BI PRO.
...
![image](https://user-images.githubusercontent.com/57469401/132227739-2458da0a-550a-44f2-80cd-7a14e24b7c0a.png)
...
Workspace criada com sucesso no Power BI Service e pronto para utilização!
